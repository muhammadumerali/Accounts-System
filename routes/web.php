...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Credential
    Route::post('verify_password', 'CredentialController@verifyPassword')->name('verify_password');
    Route::delete('credentials/destroy', 'CredentialController@massDestroy')->name('credentials.massDestroy');

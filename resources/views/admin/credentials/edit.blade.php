    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.credentials.update", [$credential->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('platform') ? 'is-invalid' : '' }}" type="text" name="platform" id="platform" value="{{ old('platform', $credential->platform) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $credential->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('comment') ? 'is-invalid' : '' }}" name="comment" id="comment">{{ old('comment', $credential->comment) }}</textarea>
